...
class Keywords implements ArrayAccess, IteratorAggregate, IJsonType
{
    /** @var PlainText[] $data The list of keywords. */
    private array $data;

    /**
     * Constructor for the Keywords class.
     *
     ...
     *
     * @return PlainText[] The value of the Keywords object.
     */
