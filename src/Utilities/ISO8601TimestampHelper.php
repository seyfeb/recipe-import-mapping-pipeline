...
use RecipeImportPipeline\Exceptions\InvalidTimestampException;

/**
 * Parser for ISO8601 and other timestamps. Currently only ISO8601 is supported.
 */
class ISO8601TimestampHelper
{
	...
	public function parseTimestamp(string $timestamp): string {
		...
		throw new InvalidTimestampException('Could not parse timestamp');
	}
